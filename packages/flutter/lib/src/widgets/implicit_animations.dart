...
class Animated3dRotation extends ImplicitlyAnimatedWidget {
  // ignore: public_member_api_docs
  const Animated3dRotation({
    Key? key,
    required this.child,
    this.x = 0,
    this.y = 0,
  ...
  @override
  AnimatedWidgetBaseState<Animated3dRotation> createState() =>
      _Animated3dRotationState();
}

class _Animated3dRotationState
    extends AnimatedWidgetBaseState<Animated3dRotation> {
  Tween<double>? _x;
  Tween<double>? _y;
  Tween<double>? _z;
  ...
  @override
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _x = visitor(_x, widget.x,
            (dynamic value) => Tween<double>(begin: value as double))
        as Tween<double>?;
    _y = visitor(_y, widget.y,
            (dynamic value) => Tween<double>(begin: value as double))
        as Tween<double>?;
    _z = visitor(_z, widget.z,
            (dynamic value) => Tween<double>(begin: value as double))
        as Tween<double>?;
  }
  ...
  @override
  Widget build(BuildContext context) {
    final double x = _x!.evaluate(animation);
    final double y = _y!.evaluate(animation);
    final double z = _z!.evaluate(animation);
    return Transform(
